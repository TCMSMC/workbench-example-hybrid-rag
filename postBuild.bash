...
# Install PyTorch CPU and its companions first for api-env
$HOME/.conda/envs/api-env/bin/pip install torch==2.1.1 --index-url https://download.pytorch.org/whl/cpu
$HOME/.conda/envs/api-env/bin/pip install torchvision --index-url https://download.pytorch.org/whl/cpu
$HOME/.conda/envs/api-env/bin/pip install torchaudio --index-url https://download.pytorch.org/whl/cpu

# Now install other API dependencies
...
$HOME/.conda/envs/ui-env/bin/pip install dataclass_wizard==0.22.2 gradio==4.15.0 jinja2==3.1.2 numpy==1.25.2 protobuf==3.20.3 PyYAML==6.0 uvicorn==0.22.0 tiktoken==0.7.0 regex==2024.5.15 fastapi==0.112.2

# Install PyTorch CPU separately
$HOME/.conda/envs/ui-env/bin/pip install torch==2.1.1 --index-url https://download.pytorch.org/whl/cpu
# You might also need torchvision and torchaudio if other parts of UI or chain_server use them,
# even if not explicitly listed as direct dependencies before. It's safer to include them.
$HOME/.conda/envs/ui-env/bin/pip install torchvision --index-url https://download.pytorch.org/whl/cpu
$HOME/.conda/envs/ui-env/bin/pip install torchaudio --index-url https://download.pytorch.org/whl/cpu
